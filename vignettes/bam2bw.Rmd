...
```{r plotBw1, fig.width=5, fig.height=3}
...
```{r plotBw2, fig.width=5, fig.height=3.5}
# Using mean per bin:
...
```{r plotBwExtended, fig.width=5, fig.height=3}
...
```{r plotBwEnds, fig.width=5, fig.height=3.5}
# Here the reads are 50bp, and we want to extend them to 100bp, hence _by_ 50:
